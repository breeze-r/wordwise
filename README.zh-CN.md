...
安装完成后，**打开任意英文网页**即可自动工作。

### 阅读标注

- 生词会在原文中直接标注简短中文翻译（青色小字）
- 根据你设置的词汇等级，已掌握的常见词不会被标注
- 全自动运行，无需任何操作

### 查词详情

- **点击**任意标注词，弹出详情面板
- 查看音标、词性、多义项释义，以及该词在原文中的上下文
- 点击 **「加入生词本」** 收录该词，或点击 **「认识」** 标记为已掌握

### AI 文章摘要

- 文章内容足够长时，右下角会出现一个**浮动按钮**（延迟 2 秒显示）
- 点击即可生成中英双语结构化大纲
- 通过顶部 **中 / EN / 双** 按钮切换显示语言
- 摘要包含：标题、核心概述、分段要点

### 插件弹窗

点击 Chrome 工具栏中的 WordWise 图标：

- 查看词汇统计（词汇量 / 生词 / 学习中 / 已掌握）
- 开关插件
- 设置英语水平，控制哪些词需要标注
- 启用专业词典包（GRE、托福、医学、科技等）
- 配置后端地址和 LLM 翻译设置
